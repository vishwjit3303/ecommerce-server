...
//		product.getCategory().
	...
	@Override
	public Page<Product> findProductsByFilters(String category, List<String> color, List<String> size, Integer minPrice,
			Integer maxPrice, Integer minDiscount, String stock, Pageable pageable) {
